...
Each test asserts a response shape that frontend/src/contract/types.ts declares —
...
# Mirrors `Strategy` in frontend/src/contract/types.ts.
STRATEGY_FIELDS = {
...
# Mirrors `Alert` in frontend/src/contract/types.ts.
ALERT_FIELDS = {
...
# Mirrors `ReplayResult` in frontend/src/contract/types.ts.
REPLAY_FIELDS = {
    "strategy_id", "ticker", "condition", "provider", "synthetic",
    "cooldown_bars", "bars", "fire_count", "fires", "dates", "closes",
}

# Mirrors `MarketAnalysis` in frontend/src/contract/types.ts.
ANALYSIS_FIELDS = {
    "ticker", "provider", "synthetic", "dates", "closes",
    "latest_price", "indicators",
}

# Mirrors `EvaluateResult.status` in frontend/src/contract/types.ts (plus the
