...
Open [`backend/marketdata/providers.py`](../backend/marketdata/providers.py). A market is this dataclass — a list of closes and their dates, nothing more:
...
Now the percent-change indicator, in [`backend/marketdata/indicators.py`](../backend/marketdata/indicators.py) — §1.2 verbatim:
