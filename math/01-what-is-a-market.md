...
Open [`backend/markets/providers.py`](../backend/markets/providers.py). A market is this dataclass — a list of closes and their dates, nothing more:
...
Now the percent-change indicator, in [`backend/markets/indicators.py`](../backend/markets/indicators.py) — §1.2 verbatim:
