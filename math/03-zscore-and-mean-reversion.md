...
Open [`backend/markets/indicators.py`](../backend/markets/indicators.py). First, the z-score itself — the rolling window of §3.3, the two Chapter-2 statistics, and the flat-window guard, all in six lines:
