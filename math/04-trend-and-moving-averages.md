...
Open [`backend/markets/indicators.py`](../backend/markets/indicators.py). Here is the simple moving average — §4.3, a sliding flat average, with the first `window−1` slots left as `None` for the warm-up:
